(function () {
  ...
  const symbolGroups = [
    ...
    },
    {
      ...
      label: 'Text',
      items: [
        { name: 'textbf', value: '\\textbf{}', preview: 'B' },
        { name: 'textit', value: '\\textit{}', preview: 'I' },
        { name: 'emph', value: '\\emph{}', preview: 'em' },
        { name: 'underline', value: '\\underline{}', preview: 'U' },
        { name: 'texttt', value: '\\texttt{}', preview: 'tt' },
        { name: 'footnote', value: '\\footnote{}', preview: 'fn' },
        { name: 'cite', value: '\\cite{}', preview: '@' },
        { name: 'ref', value: '\\ref{}', preview: 'ref' },
        { name: 'label', value: '\\label{}', preview: 'lbl' },
